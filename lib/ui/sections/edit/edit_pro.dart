...
class EditSectionAllProduct extends StatelessWidget {
  SectionsModel sectionsModel;
  bool showOrederNow;

  EditSectionAllProduct(
      {required this.sectionsModel, required this.showOrederNow});
                  ...
                  return InkWell(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                EditProductDetails(addProductModel: product,SecId: sectionsModel.id ?? ""),
                          ),
                        );
                      },
